...
class Scraper():
    def __init__(self):
        ...
        def get_matchup_time(match_time):
            # parse UTC string
        ...
        # get all matchup info (not player data)
        def get_all_matchups(schedule, i):
            ...
            matchup_start_time = get_matchup_time(matchup_utc)
        ...
        for i in range(self.num_games):
            self.matchups.append(get_all_matchups(self.schedule, i))
